                                        ...
                                        <div class="mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6" [class.col-lg-8]="sideDashboards.length" [class.col-lg-12]="!sideDashboards.length">
                                                    ...
                                                    echo <<<END
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="//gadgetforyou.pl$routeLink" class="menu-link $isPathActive">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                                <div class="d-flex flex-column me-5">
                                                    <div class="fs-6 fw-bold text-gray-800">App Settings</div>
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5 my-1">
                            <a href="././demo43/dist/account/settings.html" class="menu-link px-5">App Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
