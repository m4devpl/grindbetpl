...
$tradingPlanID = $_POST['tradingPlanID'];
...
$position_rr = "1:".$position_rr;
$position_profit = htmlentities($_POST['position_profit'], ENT_QUOTES);

$tradingMgt->addNewTradingPosition($tradingPlanID, $position_exec_date, $position_currency_pair, $position_state, $position_rr, $position_profit, '', '', '', '');
