                        ...
                        <div class="d-flex flex-stack flex-row-fluid">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64b78096a0975">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64b78096a0975" data-allow-clear="true">
                                                        <option></option>
                                ...
                                <div class="card mb-6 mb-xl-9">
                                    <div class="card-body pt-9 pb-0">
                                        ...
                                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                            ...
                                            <!--begin::Nav item-->
                                            <li class="nav-item">
                                                <a class="nav-link text-active-primary py-5 me-6 active" href="//grindbet.pl/home/projects/users?project=1">Users</a>
                                            </li>
                                            <!--end::Nav item-->
                                            <!--begin::Nav item-->
                                            <li class="nav-item">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                        ...
                                                        <div class="symbol symbol-65px symbol-circle mb-5">
                                                            <img src="//grindbet.pl/assets/media//avatars/300-2.jpg" alt="image" />
                                            ...
                                            <div class="col-md-6 col-xxl-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-65px symbol-circle mb-5">
                                                            <img src="//grindbet.pl/assets/media//avatars/300-1.jpg" alt="image" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                            ...
                                            <div class="col-md-6 col-xxl-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-65px symbol-circle mb-5">
                                                            <img src="//grindbet.pl/assets/media//avatars/300-14.jpg" alt="image" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                            ...
                                            <div class="col-md-6 col-xxl-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-65px symbol-circle mb-5">
                                                            <img src="//grindbet.pl/assets/media//avatars/300-6.jpg" alt="image" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
                                            ...
                                            <div class="col-md-6 col-xxl-4">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                        <!--begin::Avatar-->
                                                        <div class="symbol symbol-65px symbol-circle mb-5">
                                                            <img src="//grindbet.pl/assets/media//avatars/300-12.jpg" alt="image" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Name-->
